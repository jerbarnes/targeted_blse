...
if __name__ == '__main__':
    ...
    parser.add_argument('-se', '--embeddings', default='embeddings/sg-300-en.txt')
    ...
    if args.binary:
        ...
        trg_test = open_dataset(os.path.join('annotation', 'datasets', args.trg_lang), args.trg_lang, mt=True)
