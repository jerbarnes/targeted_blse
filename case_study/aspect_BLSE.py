...
if __name__ == '__main__':
    ...
    if args.binary:
        ...
        train_data = [(l,r,t,y) if y == 0 else (l,r,t,1) for l,r,t,y in train_data]
        dev_data = [(l,r,t,y) for l,r,t,y in dev_data if y in [0,2]]
        dev_data = [(l,r,t,y) if y == 0 else (l,r,t,1) for l,r,t,y in dev_data]
        test_data = [(l,r,t,y) for l,r,t,y in test_data if y in [0,2]]
        test_data = [(l,r,t,y) if y == 0 else (l,r,t,1) for l,r,t,y in test_data]
        
        trg_test = open_dataset(os.path.join('annotation', 'datasets', args.trg_lang), args.trg_lang)
        trg_test = [(l,r,t,y) for l,r,t,y in trg_test if y in [0,2]]
        trg_test = [(l,r,t,y) if y == 0 else (l,r,t,1) for l,r,t,y in trg_test]
    ...
    outfile = os.path.join('predictions','{0}-{1}'.format(args.src_lang, args.trg_lang),
                            'aBLSE-binary:{0}_epochs:{1}_learningrate:{2}_weightdecay:{3}_batchsize:{4}-embeddings:{5}.txt'.format(
