...
if __name__ == '__main__':
    ...
    synonyms1, synonyms2, neg = get_syn_ant(args.trg_lang, src_vecs)
    ...
    outfile = os.path.join('predictions', args.src_dataset, '{0}-{1}'.format(args.src_lang, args.trg_lang),
                            'aVecMap-binary:{0}_epochs:{1}_learningrate:{2}_weightdecay:{3}_batchsize:{4}.txt'.format(
    ...
    cross_dev_f1 = aVec.history['cross_f1'][-1]
